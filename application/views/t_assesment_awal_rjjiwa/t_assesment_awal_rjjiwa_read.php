...
<div class="row">
    <div class="col-xl-12">
	    ...
	    <tr><td>IDXDAFTAR</td><td><?php echo $IDXDAFTAR; ?></td></tr>
	    <tr><td>NOMR</td><td><?php echo $NOMR; ?></td></tr>
	    <tr><td>ALERGI</td><td><?php echo $ALERGI; ?></td></tr>
	    <tr><td>JAMMULAI</td><td><?php echo $JAMMULAI; ?></td></tr>
	    <tr><td>ANAMNESE</td><td><?php echo $ANAMNESE; ?></td></tr>
	    ...
	    <tr><td>RAWAT INAP</td><td><?php echo $RAWAT_INAP; ?></td></tr>
	    <tr><td>RUJUK LUAR</td><td><?php echo $RUJUK_LUAR; ?></td></tr>
	    <tr><td>RUJUK LAINNYA</td><td><?php echo $RUJUK_LAINNYA; ?></td></tr>
	    <tr><td>TTD PASIEN</td><td><?php echo $TTD_PASIEN; ?></td></tr>
	    <tr><td>TTD DOKTER</td><td><?php echo $TTD_DOKTER; ?></td></tr>
