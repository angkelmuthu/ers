...
<table class='table table-striped'>
	    ...
	    <tr><td width='200'>S <?php echo form_error('s') ?></td><td><input type="text" class="form-control" name="s" id="s" placeholder="S" value="<?php echo $s; ?>" /></td></tr>
	    <tr><td width='200'>O <?php echo form_error('o') ?></td><td><input type="text" class="form-control" name="o" id="o" placeholder="O" value="<?php echo $o; ?>" /></td></tr>
	    <tr><td width='200'>A <?php echo form_error('a') ?></td><td><input type="text" class="form-control" name="a" id="a" placeholder="A" value="<?php echo $a; ?>" /></td></tr>
	    <tr><td width='200'>P <?php echo form_error('p') ?></td><td><input type="text" class="form-control" name="p" id="p" placeholder="P" value="<?php echo $p; ?>" /></td></tr>
