...
$string .= "\n\t\t\t<td style=\"text-align:center\" width=\"200px\">"
    . "\n\t\t\t\t<?php "
    . "\n\t\t\t\techo anchor(site_url('" . $c_url . "/read/'.\$data->id),'<i class=\"fal fa-eye\" aria-hidden=\"true\"></i>','class=\"btn btn-info btn-xs waves-effect waves-themed\"'); "
    . "\n\t\t\t\techo '  '; "
    . "\n\t\t\t\techo anchor(site_url('" . $c_url . "/update/'.\$data->nomr.'/'.\$data->idxdaftar.'/'.\$data->id),'<i class=\"fal fa-pencil\" aria-hidden=\"true\"></i>','class=\"btn btn-warning btn-xs waves-effect waves-themed\"'); "
    . "\n\t\t\t\techo '  '; "
    . "\n\t\t\t\techo
    ...
    <div class=\"modal-dialog modal-sm\" role=\"document\">
        <div class=\"modal-content\">
            ...
            <div class=\"modal-footer\">
                ...
                <a href=\"'.base_url().'" . $c_url . "/delete/'.\$data->id.'/'.\$data->nomr.'/'.\$data->idxdaftar.'\" class=\"btn btn-primary\">Ya, Hapus</a>
            </div>
        </div>
    </div>
</div>';"
